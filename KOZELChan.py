...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    merek = random.choice(['SHARK MBU-H0','M2101K7BL','MI 9 Transparent Edition','ASUS_Z01QD','ME302C','ME302KL','vivo X21UD A','Vivo 1605','vivo 1002T'])
    ...
    u1 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; {merek} Build/{build}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/.{str(rr(0,4))} Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 VivoBrowser/5.8.0.1"
    u2 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; {merek} Build/{build}.{str(rr(111111,210000))}.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 XiaoMi/MiuiBrowser/17.1.6 swan-mibrowser"
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}.{merek} Build/{build}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/.{str(rr(0,4))} Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36[FBAN/EMA;FBLC/id_ID;FBAV/364.0.0.14.77;]"
